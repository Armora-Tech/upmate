...
class _MainPageWidgetState extends State<MainPageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if ((currentUserDocument?.interests?.toList() ?? []).length > 0) {
        FFAppState().update(() {
          FFAppState().addToInterestColors(FlutterFlowTheme.of(context).primaryColor);
        });
        return;
      } else {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<UsersRecord>(
      future: (_documentRequestCompleter ??= Completer<UsersRecord>()..complete(UsersRecord.getDocumentOnce(currentUserReference!))).future,
                      ...
                      Padding(
                        ...
                        child: FutureBuilder<List<UsersRecord>>(
                          future: queryUsersRecordOnce(
                            queryBuilder: (usersRecord) => usersRecord.where('email', isEqualTo: 'care@armora-tech.com'),
                            singleRecord: true,
                          ),
                          builder: (context, snapshot) {
                            // Customize what your widget looks like when it's loading.
                            ...
                            List<UsersRecord> csContainerUsersRecordList = snapshot.data!;
                            final csContainerUsersRecord = csContainerUsersRecordList.isNotEmpty ? csContainerUsersRecordList.first : null;
                            return InkWell(
                              onTap: () async {
                                context.pushNamed(
                                  'chatPage',
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(10, 0, 0, 0),
                                      child: Icon(
                                        FFIcons.kdlbeatsnoopcomBb958e199ce43eabfeAdobeExpress,
                                        color: Colors.black,
                                        size: 30,
                                      ),
                                    ),
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        FFAppState().isFirstOpen ? 'Selamat Datang' : currentUserDisplayName,
                                        style: FlutterFlowTheme.of(context).bodyText1.override(
                                              fontFamily: 'Nunito',
                                              fontSize: 18,
                                              fontWeight: FontWeight.normal,
                                  ...
                                  builder: (context) => FutureBuilder<List<UsersRecord>>(
                                    future: queryUsersRecordOnce(
                                      queryBuilder: (usersRecord) =>
                                          usersRecord.whereArrayContainsAny('interests', (currentUserDocument?.interests?.toList() ?? [])),
                                      limit: 10,
                                    ),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      ...
                                      List<UsersRecord> peoplereccRowUsersRecordList = snapshot.data!.where((u) => u.uid != currentUserUid).toList();
                                      return SingleChildScrollView(
                                        scrollDirection: Axis.horizontal,
                                        child: Row(
                                          mainAxisSize: MainAxisSize.max,
                                          children: List.generate(peoplereccRowUsersRecordList.length, (peoplereccRowIndex) {
                                            final peoplereccRowUsersRecord = peoplereccRowUsersRecordList[peoplereccRowIndex];
                                            return Card(
                                                ...
                                                decoration: BoxDecoration(
                                                  image: DecorationImage(
                                                    ...
                                                    image: CachedNetworkImageProvider(
                                                      valueOrDefault<String>(
                                                        peoplereccRowUsersRecord.photoUrl,
                                                        ...
                                                        child: BackdropFilter(
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                Text(
                                                                  peoplereccRowUsersRecord.displayName!,
                                                                ...
                                                                Text(
                                                                  functions.joinLString(peoplereccRowUsersRecord.interests!.toList(), ' | ')!,
                                                                  textAlign: TextAlign.center,
                                                                  maxLines: 1,
                                                                  style: FlutterFlowTheme.of(context).bodyText1.override(
                                                                        fontFamily: 'Nunito',
                                    ...
                                    builder: (context) => StreamBuilder<List<PostsRecord>>(
                                      stream: queryPostsRecord(
                                        queryBuilder: (postsRecord) => postsRecord
                                            .whereArrayContainsAny('interests', (currentUserDocument?.interests?.toList() ?? []))
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<PostsRecord> personalizedColumnPostsRecordList = snapshot.data!;
                                        return Column(
                                          mainAxisSize: MainAxisSize.max,
                                          children: List.generate(personalizedColumnPostsRecordList.length, (personalizedColumnIndex) {
                                            final personalizedColumnPostsRecord = personalizedColumnPostsRecordList[personalizedColumnIndex];
                                            return Container(
                                              width: MediaQuery.of(context).size.width,
                                              decoration: BoxDecoration(
                                                border: Border.all(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                      ...
                                                      children: [
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              Text(
                                                                personalizedColumnPostsRecord.postTitle!.maybeHandleOverflow(maxChars: 20),
                                                                style: FlutterFlowTheme.of(context).bodyText1.override(
                                                                      fontFamily: 'Nunito',
                                                                      fontWeight: FontWeight.bold,
                                                                    ),
                                                  ...
                                                  if (personalizedColumnPostsRecord.postPhoto != null && personalizedColumnPostsRecord.postPhoto != '')
                                                    Padding(
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Row(
                                                      mainAxisSize: MainAxisSize.max,
                                                      children: [
                                                        if (random_data.randomInteger(0, 10) == 11)
                                                          Expanded(
                                                            child: Wrap(
                                                              spacing: 0,
                                                              runSpacing: 0,
                                                              ...
                                                              children: [
                                                                Visibility(
                                                                  visible: personalizedColumnPostsRecord.postPhoto == null ||
                                                                      personalizedColumnPostsRecord.postPhoto == '',
                                                                  child: Padding(
                                                                    padding: EdgeInsetsDirectional.fromSTEB(0, 5, 0, 5),
                                                                    child: Text(
                                                                      personalizedColumnPostsRecord.postDescription!.maybeHandleOverflow(
                                                                        maxChars: 100,
                                                                        replacement: '…',
                                                                      ),
                                                                      textAlign: TextAlign.justify,
                                                    ...
                                                    children: [
                                                          ...
                                                          Container(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                ToggleIcon(
                                                                  onPressed: () async {
                                                                    setState(() => FFAppState().unused = !FFAppState().unused);
                                                                  },
                                                      ...
                                                      Column(
                                                        ...
                                                        children: [
                                                          ToggleIcon(
                                                            onPressed: () async {
                                                              final bookmarksElement = currentUserReference;
                                                              final bookmarksUpdate =
                                                                  personalizedColumnPostsRecord.bookmarks!.toList().contains(bookmarksElement)
                                                                      ? FieldValue.arrayRemove([bookmarksElement])
                                                                      : FieldValue.arrayUnion([bookmarksElement]);
                                                              final postsUpdateData = {
                                                                'bookmarks': bookmarksUpdate,
                                                              };
                                                              await personalizedColumnPostsRecord.reference.update(postsUpdateData);
                                                            },
                                                            value: personalizedColumnPostsRecord.bookmarks!.toList().contains(currentUserReference),
                                                            onIcon: Icon(
                                                          ...
                                                          Text(
                                                            formatNumber(
                                                              personalizedColumnPostsRecord.bookmarks!.toList().length,
                                                              ...
                                                              children: [
                                                                ...
                                                                FutureBuilder<List<CommentsRecord>>(
                                                                  future: queryCommentsRecordOnce(
                                                                    parent: personalizedColumnPostsRecord.reference,
                                                                  ),
                                                                  builder: (context, snapshot) {
                                                                    // Customize what your widget looks like when it's loading.
                                                                    if (!snapshot.hasData) {
                                                                    ...
                                                                    return InkWell(
                                                                      ...
                                                                      child: Text(
                                                                        formatNumber(
                                                                          personalizedColumnPostsRecord.numComments!,
                                                                          formatType: FormatType.compact,
                                                                        ),
                                                                        style: FlutterFlowTheme.of(context).bodyText1.override(
                                                                              fontFamily: 'Nunito',
                                                      ...
                                                      InkWell(
                                                        onTap: () async {
                                                          if (personalizedColumnPostsRecord.likes!.toList().contains(currentUserReference)) {
                                                            final postsUpdateData = {
                                                          ...
                                                          children: [
                                                            ToggleIcon(
                                                              onPressed: () async {
                                                                ...
                                                                final likesUpdate = personalizedColumnPostsRecord.likes!.toList().contains(likesElement)
                                                              ...
                                                              value: personalizedColumnPostsRecord.likes!.toList().contains(currentUserReference),
                                                              onIcon: Icon(
                                                                Icons.favorite,
                                                            ...
                                                            Text(
                                                              formatNumber(
                                                                personalizedColumnPostsRecord.likes!.toList().length,
                                                                formatType: FormatType.compact,
                                                              ),
                                                          ...
                                                          child: Wrap(
                                                            ...
                                                            children: [
                                                              Padding(
                                                                padding: EdgeInsetsDirectional.fromSTEB(0, 5, 0, 5),
                                                                child: Text(
                                                                  personalizedColumnPostsRecord.postDescription!.maybeHandleOverflow(maxChars: 50),
                                                                  textAlign: TextAlign.justify,
                                                                  style: FlutterFlowTheme.of(context).bodyText1.override(
                                                                        fontFamily: 'Nunito',
                                                                        fontSize: 12,
                                                  ...
                                                  if (personalizedColumnPostsRecord.numComments! > 5)
                                                    Padding(
                                                      padding: EdgeInsetsDirectional.fromSTEB(24, 0, 24, 0),
                                                      child: Row(
                                                        mainAxisSize: MainAxisSize.max,
                                                  ...
                                                  FutureBuilder<List<CommentsRecord>>(
                                                    future: queryCommentsRecordOnce(
                                                      parent: personalizedColumnPostsRecord.reference,
                                                      queryBuilder: (commentsRecord) => commentsRecord.orderBy('date', descending: true),
                                                      limit: 3,
                                                    ),
                                                    builder: (context, snapshot) {
                                                      // Customize what your widget looks like when it's loading.
                                                      ...
                                                      return Column(
                                                        mainAxisSize: MainAxisSize.min,
                                                        children: List.generate(columnCommentsRecordList.length, (columnIndex) {
                                                          final columnCommentsRecord = columnCommentsRecordList[columnIndex];
                                                          return Column(
                                                            mainAxisSize: MainAxisSize.max,
                                                            crossAxisAlignment: CrossAxisAlignment.start,
                                                            children: [
                                                              Padding(
                                                                ...
                                                                child: FutureBuilder<UsersRecord>(
                                                                  future: UsersRecord.getDocumentOnce(columnCommentsRecord.userRef!),
                                                                  builder: (context, snapshot) {
                                                                    // Customize what your widget looks like when it's loading.
                                                                    if (!snapshot.hasData) {
                                                                      return Center(
                                                                    ...
                                                                    return Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Padding(
                                                                          padding: EdgeInsetsDirectional.fromSTEB(5, 0, 0, 0),
                                                                          child: Text(
                                                                            columnCommentsRecord.text!.maybeHandleOverflow(
                                                                              maxChars: 15,
                                                                              replacement: '…',
                                                                            ),
                                                                            maxLines: 1,
                                                                        ...
                                                                        if (functions.scount(columnCommentsRecord.text!) > 20)
                                                                          Padding(
                                                                            padding: EdgeInsetsDirectional.fromSTEB(5, 0, 0, 0),
                                                                            child: Text(
                                                                              'Selengkapnya',
                                                              ...
                                                              Padding(
                                                                padding: EdgeInsetsDirectional.fromSTEB(24, 0, 24, 7),
                                                                child: Text(
                                                                  dateTimeFormat(
                                                                    'relative',
                                                                    columnCommentsRecord.date!,
