...
class RatingPageWidget extends StatefulWidget {
  const RatingPageWidget({Key? key}) : super(key: key);

  @override
  _RatingPageWidgetState createState() => _RatingPageWidgetState();
}
